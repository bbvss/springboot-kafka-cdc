...
import com.streams.GetWeatherStationDataResult;
import com.streams.InteractiveQueries;
import com.streams.PipelineMetadata;
  ...
  public Response getWeatherStationData(@PathParam("id") int id) {
    ...
    if (result.getResult().isPresent()) {
      ...
      return Response.status(
              Status.NOT_FOUND.getStatusCode(), "No data found for weather station " + id)
              .build();
    }
  }
